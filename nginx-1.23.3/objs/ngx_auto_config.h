#define NGX_CONFIGURE " --sbin-path=/root/nginx/nginx-bin/nginx --with-cc-opt='-g -O0' --conf-path=/root/nginx/nginx-bin/nginx.conf --pid-path=/root/nginx/nginx-bin/nginx.pid --with-openssl=../openssl-1.1.1t --with-openssl-opt=-d --with-http_ssl_module --with-debug --add-module=/root/nginx/subrequest_demo --add-module=/root/nginx/append_prefix_filter_demo"
...
#define NGX_CONF_PREFIX  "/root/nginx/nginx-bin/"
#endif


#ifndef NGX_SBIN_PATH
#define NGX_SBIN_PATH  "/root/nginx/nginx-bin/nginx"
#endif


#ifndef NGX_CONF_PATH
#define NGX_CONF_PATH  "/root/nginx/nginx-bin/nginx.conf"
#endif


#ifndef NGX_PID_PATH
#define NGX_PID_PATH  "/root/nginx/nginx-bin/nginx.pid"
#endif
